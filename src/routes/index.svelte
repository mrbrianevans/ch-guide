<script>
	...
	// Typewriter
	let people = ['streaming', 'REST API', 'bulk data'];
...
<svelte:head>
	<meta content={Config.title} name="og:title"/>
...
<div class="main">
		...
		<Grid class="sp--grid" padding>
			<Row>
				<Column style="text-align: center;">
					...
					<h1 style="margin-top: 1rem">Welcome to Companies House Guide</h1>
					<h2 class="subTitle">
						Documentation for 
						<Typewriter cursor="#ff3e00" loop={3000}>
					...
					<Button
							...
							icon={ArrowRight32}
							size="lg"
							style="margin-top: 3rem">Let's get started
					</Button
					>
				</Column>
			</Row>
	...
	<Grid class="sp--grid sp--features" padding>
		<Row class="sp--feature">
			...
			>
				<Tile class="sp--tile"
				><h2 class="tile--title">Better documentation</h2>
					<h4>Unified and up-to-date documentation for Companies House APIs and datasets.</h4></Tile
				>
			</Column
			>
		</Row>
		<Row class="sp--feature" style="flex-wrap: wrap-reverse;">
			...
			>
				<Tile class="sp--tile"
				><h2 class="tile--title">FAQs</h2>
					<h4>
						Canonical answers to frequently asked questions on the developer forum.
					</h4></Tile
				>
			</Column
			>
		...
		<Row class="sp--feature">
			...
			>
				<Tile class="sp--tile"
				><h2 class="tile--title">Avoid common pitfalls</h2>
					<h4>
						A guide written by users of the Companies House API to help you avoid shooting yourself in the
						foot.
					</h4></Tile
				>
			</Column
